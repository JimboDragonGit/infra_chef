...
default["infra_chef"]["initial_command"] = "wget https://raw.githubusercontent.com/#{node['infra_chef']['project_name']}/initialize_chef_repo/master/initializator.sh && bash initializator.sh Example Test Dev QA SIT DR"
