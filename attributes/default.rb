...
Chef::Application.fatal!("Must have the attribute infra_chef => project_name") if node['infra_chef']['install_dir'] == ""
...
default["infra_chef"]["gitinfo"] = {
  ...
  "submodules": {
    ...
    "papa": {
      "type": "papa",
      "repository": "#{node['chef-git-server']['user']}@#{node["ipaddress"]}:#{node['chef-git-server']['home']}/papa.git",
      "revision": "master",
      "remote": "origin"
    }
  }
